...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('center_offset', default_value='55.0',
        ...
        DeclareLaunchArgument('k_cut_comp', default_value='2.3',
                              description='코너 파고듦 보정 배수'),
        DeclareLaunchArgument('e_soft', default_value='0.12',
